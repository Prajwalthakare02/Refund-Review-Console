...
def _serialise_order_summary(oss) -> dict:
    ...
    return {
        ...
        "approved_amount_minor": oss.approved_decision_minor,
        "approved_amount_formatted": _format_amount(oss.approved_decision_minor, cur),
        "rejected_amount_minor": oss.rejected_decision_minor,
        "rejected_amount_formatted": _format_amount(oss.rejected_decision_minor, cur),
